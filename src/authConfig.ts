...
export const msalConfig = {
  auth: {
    clientId: "b0f120e7-f483-4561-afcc-19ae1e1d0542", // This is the ONLY mandatory field that you need to supply.
    authority:
...
export const protectedResources = {
  apiList: {
    ...
    scopes: {
      read: ["https://fabrikamb2c.onmicrosoft.com"],
      write: ["https://fabrikamb2c.onmicrosoft.com"],
    },
  },
};
