    ...
    <div className='root'>
      ...
      <div className="row topContainer">
        <div className="col-sm-1" >
         <label htmlFor="checkbox" className='item'>All</label>
    ...
    <div className="cardStyling">
      <div className="row rowStyling">
        <div className="col-md-6 w-25">
          <img src={image} width={64} height={64} className="imgStyling"></img>
        </div>
        <div className="col-md-6 pr-4">
        <div className="container">
        <div className="d-flex flex-column">
      <div className='nameStyling'>Sayantan Nath</div>
      <div className='emailStyling'>sayantan.n@gmail.com</div>
